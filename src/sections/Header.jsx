...
const Header = () => {
    ...
    return (
        <header className={clsx("fixed top-0 left-0 z-50 w-full transition-all duration-500",
         hasScrolled
         ...
         : 'py-10 max-lg:py-4'
            ...
            <div className="container flex h-14 items-center max-lg:px-5">
                ...
                rounded-full flex justify-center items-center" onClick={() => setIsOpen(!isOpen)}>
